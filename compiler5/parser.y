...
%start wholeprogram
%type <treeNode> program functions function statements statement funcall arguments argument expression globals vardecl parameters paramdecl assignment ifthenelse whileloop boolexpr

/* Token types */
%token <ival> LPAREN RPAREN LBRACE RBRACE SEMICOLON ADDOP KWPROGRAM KWCALL KWFUNCTION COMMA NUMBER EQUALS KWGLOBAL KWINT KWSTRING RELOP KWRETURNVAL KWWHILE KWDO KWIF KWTHEN KWELSE
%token <str> STRING ID
